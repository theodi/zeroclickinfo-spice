define( "ace/mode/python", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/tokenizer", "ace/mode/python_highlight_rules", "ace/mode/folding/pythonic", "ace/range" ], function ( e, t, n ) {
    var r = e( "../lib/oop" );
    var i = e( "./text" ).Mode;
    var s = e( "../tokenizer" ).Tokenizer;
    var o = e( "./python_highlight_rules" ).PythonHighlightRules;
    var u = e( "./folding/pythonic" ).FoldMode;
    var a = e( "../range" ).Range;
    var f = function () {
    ...
    ( function () {
        ...
        this.checkOutdent = function ( t, n, r ) {
            ...
            if ( !s ) return false;
            return s.type == "keyword" && e[ s.value ]
        };
        this.autoOutdent = function ( e, t, n ) {
            n += 1;
            var r = this.$getIndent( t.getLine( n ) );
            var i = t.getTabString();
            if ( r.slice( -i.length ) == i ) t.remove( new a( n, r.length - i.length, n, r.length ) )
        }
    } ).call( f.prototype );
    t.Mode = f
} );
define( "ace/mode/python_highlight_rules", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules" ], function ( e, t, n ) {
    ...
    var s = function () {
        ...
        var t = "True|False|None|NotImplemented|Ellipsis|__debug__";
        ...
        var d = "(?:(?:" + p + "|" + h + ")" + l + ")";
        var v = "(?:" + d + "|" + p + ")";
        var m = "\\\\(x[0-9A-Fa-f]{2}|[0-7]{3}|[\\\\abfnrtv'\"]|U[0-9A-Fa-f]{8}|u[0-9A-Fa-f]{4})";
        this.$rules = {
            start: [ {
                token: "comment",
                regex: "#.*$"
...
define( "ace/mode/folding/pythonic", [ "require", "exports", "module", "ace/lib/oop", "ace/mode/folding/fold_mode" ], function ( e, t, n ) {
    ...
    ( function () {
        this.getFoldWidgetRange = function ( e, t, n ) {
            ...
            if ( i ) {
                if ( i[ 1 ] ) return this.openingBracketBlock( e, i[ 1 ], n, i.index );
                if ( i[ 2 ] ) return this.indentationBlock( e, n, i.index + i[ 2 ].length );
                return this.indentationBlock( e, n )
            }
        }
    } ).call( s.prototype )
} )
