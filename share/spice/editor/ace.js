( function () {
    ...
    var n = function ( e, t, r ) {
        if ( typeof e !== "string" ) {
            if ( n.original ) n.original.apply( window, arguments );
            else {
    ...
    var r = function ( e, t, n ) {
        if ( Object.prototype.toString.call( t ) === "[object Array]" ) {
            ...
            var f = s( e, t );
            if ( !f && r.original ) return r.original.apply( window, arguments );
            if ( n ) {
                n()
            }
            return f
...
define( "ace/ace", [ "require", "exports", "module", "ace/lib/fixoldbrowsers", "ace/lib/dom", "ace/lib/event", "ace/editor", "ace/edit_session", "ace/undomanager", "ace/virtual_renderer", "ace/multi_select", "ace/worker/worker_client", "ace/keyboard/hash_handler", "ace/placeholder", "ace/mode/folding/fold_mode", "ace/theme/textmate", "ace/config" ], function ( e, t, n ) {
    ...
    t.edit = function ( e ) {
        ...
        i.addListener( window, "resize", l.onResize );
...
define( "ace/lib/regexp", [ "require", "exports", "module" ], function ( e, t, n ) {
    ...
    RegExp.prototype.exec = function ( e ) {
        ...
        if ( typeof e == "string" && t ) {
            if ( !i && t.length > 1 && u( t, "" ) > -1 ) {
                ...
                r.replace.call( e.slice( t.index ), a, function () {
                    for ( var e = 1; e < arguments.length - 2; e++ ) {
                        if ( arguments[ e ] === undefined ) t[ e ] = undefined
                    }
                } )
            }
            ...
            if ( !s && this.global && !t[ 0 ].length && this.lastIndex > t.index ) this.lastIndex--
        }
        return t
    };
    if ( !s ) {
...
define( "ace/lib/es5-shim", [ "require", "exports", "module" ], function ( e, t, n ) {
        ...
        if ( function () {
            ...
            Array.prototype.splice = function ( e, t ) {
                if ( !arguments.length ) {
                    ...
                    return v.apply( this, [ e === void 0 ? 0 : e, t === void 0 ? this.length - e : t ].concat( u.call( arguments, 2 ) ) )
                }
            }
        } else {
            Array.prototype.splice = function ( e, t ) {
    ...
    if ( !Array.prototype.map ) {
        Array.prototype.map = function ( t ) {
            ...
            for ( var u = 0; u < i; u++ ) {
                if ( u in r ) s[ u ] = t.call( o, r[ u ], u, n )
            }
            return s
        }
    }
    ...
    if ( !Object.create ) {
        ...
        Object.create = function ( t, n ) {
            ...
            if ( t === null ) {
                ...
                r = new i;
                r.__proto__ = t
            } if ( n !== void 0 ) Object.defineProperties( r, n );
            return r
        }
    }
    if ( Object.defineProperty ) {
        var E = w( {} );
        var S = typeof document == "undefined" || w( document.createElement( "div" ) );
        if ( !E || !S ) {
    ...
    if ( !Object.defineProperty || x ) {
        ...
        Object.defineProperty = function ( t, n, r ) {
            ...
            if ( f( r, "value" ) ) {
                ...
                if ( f( r, "get" ) ) l( t, n, r.get );
                if ( f( r, "set" ) ) c( t, n, r.set )
            }
            return t
        }
    }
    if ( !Object.defineProperties ) {
        Object.defineProperties = function ( t, n ) {
            for ( var r in n ) {
                if ( f( n, r ) ) Object.defineProperty( t, r, n[ r ] )
            }
            return t
        }
    }
...
define( "ace/lib/dom", [ "require", "exports", "module" ], function ( e, t, n ) {
    ...
    t.hasCssString = function ( e, t ) {
        ...
        if ( t.createStyleSheet && ( r = t.styleSheets ) ) {
            while ( n < r.length )
                if ( r[ n++ ].owningElement.id === e ) return true
        } else if ( r = t.getElementsByTagName( "style" ) ) {
            while ( n < r.length )
                if ( r[ n++ ].id === e ) return true
        }
        return false
    };
    t.importCssString = function ( n, i, s ) {
        ...
        if ( s.createStyleSheet ) {
            ...
            o = s.createElementNS ? s.createElementNS( r, "style" ) : s.createElement( "style" );
    ...
    } if ( window.getComputedStyle ) t.computedStyle = function ( e, t ) {
        if ( t ) return ( window.getComputedStyle( e, "" ) || {} )[ t ] || "";
        return window.getComputedStyle( e, "" ) || {}
    };
    else t.computedStyle = function ( e, t ) {
        if ( t ) return e.currentStyle[ t ];
...
define( "ace/lib/event", [ "require", "exports", "module", "ace/lib/keys", "ace/lib/useragent", "ace/lib/dom" ], function ( e, t, n ) {
    ...
    t.getButton = function ( e ) {
        ...
        if ( e.type == "contextmenu" || e.ctrlKey && i.isMac ) return 2;
        if ( e.preventDefault ) {
            return e.button
        } else {
            return {
    ...
    t.capture = function ( e, n, r ) {
        function i( e ) {
            n && n( e );
            r && r( e );
            t.removeListener( document, "mousemove", n, true );
            t.removeListener( document, "mouseup", i, true );
            t.removeListener( document, "dragstart", i, true )
        }
        t.addListener( document, "mousemove", n, true );
        t.addListener( document, "mouseup", i, true );
        t.addListener( document, "dragstart", i, true )
    };
        ...
        if ( "onmousewheel" in e ) {
            ...
            t.addListener( e, "mousewheel", function ( e ) {
                if ( e.wheelDeltaX !== undefined ) {
                    e.wheelX = -e.wheelDeltaX / r;
                    e.wheelY = -e.wheelDeltaY / r
                } else {
                    e.wheelX = 0;
...
define( "ace/editor", [ "require", "exports", "module", "ace/lib/fixoldbrowsers", "ace/lib/oop", "ace/lib/dom", "ace/lib/lang", "ace/lib/useragent", "ace/keyboard/textinput", "ace/mouse/mouse_handler", "ace/mouse/fold_handler", "ace/keyboard/keybinding", "ace/edit_session", "ace/search", "ace/range", "ace/lib/event_emitter", "ace/commands/command_manager", "ace/commands/default_commands", "ace/config" ], function ( e, t, n ) {
    ...
    ( function () {
        ...
        this.$historyTracker = function ( e ) {
            ...
            if ( r ) this.session.mergeUndoDeltas = true;
            else if ( n.indexOf( e.command.name ) !== -1 ) this.sequenceStartTime = Date.now()
        };
        this.setKeyboardHandler = function ( e ) {
            if ( !e ) {
                ...
                g.loadModule( [ "keybinding", e ], function ( n ) {
                    if ( t.$keybindingId == e ) t.keyBinding.setKeyboardHandler( n && n.handler )
                } )
            } else {
        ...
        this.$highlightBrackets = function () {
            ...
            setTimeout( function () {
                ...
                if ( n ) e.session.$bracketHighlight = e.session.addMarker( n, "ace_bracket", "text" )
            }, 50 )
        };
        this.focus = function () {
            var e = this;
        ...
        this.onDocumentChange = function ( e ) {
            ...
            var n = t.range;
            var r;
            if ( n.start.row == n.end.row && t.action != "insertLines" && t.action != "removeLines" ) r = n.end.row;
            else r = Infinity;
        ...
        this.$updateHighlightActiveLine = function () {
            ...
            if ( this.$highlightActiveLine ) {
                ...
                if ( this.renderer.$maxLines && this.session.getLength() === 1 ) t = false
            }
        ...
        this.removeLines = function () {
            var e = this.$getSelectedRows();
            var t;
            if ( e.first === 0 || e.last + 1 < this.session.getLength() ) t = new p( e.first, 0, e.last + 1, 0 );
            else t = new p( e.first - 1, this.session.getLine( e.first - 1 ).length, e.last, this.session.getLine( e.last ).length );
            this.session.remove( t );
            this.clearSelection()
        };
        this.duplicateSelection = function () {
            ...
            if ( n.isEmpty() ) {
                ...
                var o = t.insert( s, t.getTextRange( n ), false );
                n.start = s;
                n.end = o;
        ...
        this.copyLinesUp = function () {
            this.$moveLines( function ( e, t ) {
                this.session.duplicateLines( e, t );
                return 0
            } )
        };
        ...
        this.$moveByPage = function ( e, t ) {
            ...
            if ( t != null ) n.scrollCursorIntoView( null, .5 );
        ...
        this.jumpToMatching = function ( e ) {
            ...
            if ( !n ) {
                ...
                if ( !n ) return;
                var r = n.start;
                if ( r.row == t.row && Math.abs( r.column - t.column ) < 2 ) n = this.session.getBracketRange( r )
            }
            r = n && n.cursor || r;
            if ( r ) {
                if ( e ) {
                    if ( n && n.isEqual( this.getSelectionRange() ) ) this.clearSelection();
                    else this.selection.selectTo( r.row, r.column )
                } else {
                    this.clearSelection();
        ...
        this.gotoLine = function ( e, t, n ) {
            ...
            this.$blockScrolling -= 1;
            if ( !this.isRowFullyVisible( e - 1 ) ) this.scrollToLine( e - 1, true, n )
        };
        ...
        this.find = function ( e, t, n ) {
            ...
            else if ( typeof e == "object" ) r.mixin( t, e );
            ...
            if ( s ) {
                this.revealRange( s, n );
                return s
            }
            if ( t.backwards ) i.start = i.end;
            else i.end = i.start;
        ...
        this.revealRange = function ( e, t ) {
            ...
            if ( t != false ) this.renderer.animateScrolling( n )
        };
        this.undo = function () {
            this.$blockScrolling++;
        ...
        this.setAutoScrollEditorIntoView = function ( e ) {
            ...
            var o = this.renderer.on( "beforeRender", function () {
                if ( r ) t = n.renderer.container.getBoundingClientRect()
            } );
...
define( "ace/lib/lang", [ "require", "exports", "module" ], function ( e, t, n ) {
    ...
    t.copyArray = function ( e ) {
        ...
        for ( var n = 0, r = e.length; n < r; n++ ) {
            if ( e[ n ] && typeof e[ n ] == "object" ) t[ n ] = this.copyObject( e[ n ] );
            else t[ n ] = e[ n ]
        }
        return t
    };
    ...
    var a = function ( e, t ) {
        ...
        function F() {
            setTimeout( function () {
                ...
                if ( t.renderer.$keepTextAreaAtCursor == null ) {
                    t.renderer.$keepTextAreaAtCursor = true;
        ...
        if ( i.isTouchPad ) n.setAttribute( "x-palm-disable-auto-cap", true );
        n.wrap = "off";
        n.autocorrect = "off";
        ...
        if ( i.isOldIE ) {
            ...
            r.addListener( n, "keyup", function ( e ) {
                if ( h && ( !n.value || N[ e.keyCode ] ) ) setTimeout( B, 0 );
        ...
        var A = function ( e ) {
            ...
            if ( c ) {
                ...
                if ( L ) t.execCommand( "del", {
                    source: "ace"
                } )
            } else {
                if ( e.substring( 0, 2 ) == a ) e = e.substr( 2 );
                else if ( e.charAt( 0 ) == a.charAt( 0 ) ) e = e.substr( 1 );
                else if ( e.charAt( e.length - 1 ) == a.charAt( 0 ) ) e = e.slice( 0, -1 );
                if ( e.charAt( e.length - 1 ) == a.charAt( 0 ) ) e = e.slice( 0, -1 );
                if ( e ) t.onTextInput( e )
            } if ( L ) L = false
        };
        var O = function ( e ) {
            if ( h ) return;
        ...
        if ( !( "oncut" in n ) || !( "oncopy" in n ) || !( "onpaste" in n ) ) {
        ...
        var B = function ( e ) {
            ...
            var i = setTimeout( function () {
                ...
                var e = n.value.replace( /\x01/g, "" );
                if ( h ) return;
                else if ( e == r.lastValue ) w();
                else if ( !r.lastValue && e ) {
                    w();
                    A( e )
                }
            } );
            k = function ( n ) {
                if ( i ) clearTimeout( i );
                n = n.replace( /\x01/g, "" );
                if ( n == r.lastValue ) return "";
                if ( r.lastValue && i ) t.undo();
                return n
            };
            t.onCompositionEnd();
            t.removeListener( "mousedown", B );
            if ( e.type == "compositionend" && r.range ) {
        ...
        this.onContextMenu = function ( e ) {
            ...
            if ( i.isWin ) r.capture( t.container, c, F )
        };
...
define( "ace/mouse/mouse_handler", [ "require", "exports", "module", "ace/lib/event", "ace/lib/useragent", "ace/mouse/default_handlers", "ace/mouse/default_gutter_handler", "ace/mouse/mouse_event", "ace/mouse/dragdrop_handler", "ace/config" ], function ( e, t, n ) {
    ...
    ( function () {
        ...
        this.captureMouse = function ( e, t ) {
            ...
            if ( n.$keepTextAreaAtCursor ) n.$keepTextAreaAtCursor = null;
            var s = this;
            var o = function ( e ) {
                s.x = e.clientX;
                s.y = e.clientY;
            ...
            var u = function ( e ) {
                ...
                if ( n.$keepTextAreaAtCursor == null ) {
                    n.$keepTextAreaAtCursor = true;
...
define( "ace/mouse/default_handlers", [ "require", "exports", "module", "ace/lib/dom", "ace/lib/event", "ace/lib/useragent" ], function ( e, t, n ) {
    ...
    function f( e, t ) {
        ...
        else var n = 2 * t.row - e.start.row - e.end.row; if ( n < 0 ) return {
            cursor: e.start,
            anchor: e.end
        };
        else return {
    ...
    ( function () {
        ...
        this.startSelect = function ( e ) {
            ...
            if ( t.renderer.scroller.setCapture ) {
...
define( "ace/mouse/dragdrop_handler", [ "require", "exports", "module", "ace/lib/dom", "ace/lib/event", "ace/lib/useragent" ], function ( e, t, n ) {
    function f( e ) {
        ...
        function N( e, n ) {
            ...
            if ( h || v && !m ) {
                if ( !E ) E = r;
                else if ( r - E >= o ) t.renderer.scrollCursorIntoView( c )
            } else {
                E = null
            }
        }
        ...
        function L() {
            ...
            t.$blockScrolling -= 1;
            if ( t.isFocused() && !w ) t.renderer.$cursorLayer.setBlinking( !t.getReadOnly() );
            m = null;
            y = 0;
            E = null;
            S = null;
        ...
        function _( e ) {
            ...
            var o = "none";
            if ( r && t.indexOf( i ) >= 0 ) o = "copy";
            else if ( n.indexOf( i ) >= 0 ) o = "move";
            else if ( t.indexOf( i ) >= 0 ) o = "copy";
            return o
        }
        var t = e.editor;
        var n = r.createElement( "img" );
        n.src = "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==";
        if ( s.isOpera ) n.style.cssText = "width:1px;height:1px;position:fixed;top:0;left:0;z-index:2147483647;opacity:0;";
        ...
        this.onDragEnd = function ( e ) {
            ...
            if ( !t.getReadOnly() ) {
                ...
                if ( !b && n == "move" ) t.session.remove( t.getSelectionRange() );
                t.renderer.$cursorLayer.setBlinking( true )
            }
...
define( "ace/config", [ "require", "exports", "module", "ace/lib/lang", "ace/lib/oop", "ace/lib/net", "ace/lib/event_emitter" ], function ( e, t, n ) {
    ...
    t.moduleUrl = function ( e, t ) {
        ...
        if ( ( !i || i == t ) && n.length > 1 ) i = n[ n.length - 2 ];
        var o = a[ t + "Path" ];
        if ( o == null ) {
            o = a.basePath
        } else if ( r == "/" ) {
    ...
    t.init = function () {
        ...
        delete r.base;
        for ( var g in r )
            if ( typeof r[ g ] !== "undefined" ) t.set( g, r[ g ] )
    };
    var l = {
        ...
        setOption: function ( e, t ) {
            ...
            if ( !n ) {
                if ( typeof console != "undefined" && console.warn ) console.warn( 'misspelled option "' + e + '"' );
                return undefined
            }
            if ( n.forwardTo ) return this[ n.forwardTo ] && this[ n.forwardTo ].setOption( e, t );
            if ( !n.handlesSet ) this[ "$" + e ] = t;
            if ( n && n.set ) n.set.call( this, t )
        },
    ...
    t.defineOptions = function ( e, t, n ) {
        ...
        Object.keys( n ).forEach( function ( t ) {
            ...
            r.name || ( r.name = t );
            e.$options[ r.name ] = r;
            if ( "initialValue" in r ) e[ "$" + r.name ] = r.initialValue
        } );
        i.implement( e, l );
        return this
    };
    t.resetOptions = function ( e ) {
        Object.keys( e.$options ).forEach( function ( t ) {
            var n = e.$options[ t ];
            if ( "value" in n ) e.setOption( t, n.value )
        } )
    };
    t.setDefaultValue = function ( e, n, r ) {
        var i = c[ e ] || ( c[ e ] = {} );
        if ( i[ n ] ) {
            if ( i.forwardTo ) t.setDefaultValue( i.forwardTo, n, r );
            else i[ n ].value = r
        }
    };
...
define( "ace/lib/event_emitter", [ "require", "exports", "module" ], function ( e, t, n ) {
    ...
    r._emit = r._dispatchEvent = function ( e, t ) {
        ...
        if ( !t.type ) t.type = e;
        if ( !t.stopPropagation ) t.stopPropagation = i;
    ...
    r.removeDefaultHandler = function ( e, t ) {
        ...
        if ( n[ e ] == t ) {
            var i = n[ e ];
            if ( r ) this.setDefaultHandler( e, r.pop() )
        } else if ( r ) {
            var s = r.indexOf( t );
            if ( s != -1 ) r.splice( s, 1 )
        }
    ...
    r.on = r.addEventListener = function ( e, t, n ) {
        ...
        if ( !r ) r = this._eventRegistry[ e ] = [];
        if ( r.indexOf( t ) == -1 ) r[ n ? "unshift" : "push" ]( t );
        return t
    };
...
define( "ace/mouse/fold_handler", [ "require", "exports", "module" ], function ( e, t, n ) {
    function r( e ) {
        e.on( "click", function ( t ) {
            ...
            if ( i ) {
                if ( t.getAccelKey() ) r.removeFold( i );
                else r.expandFold( i );
                t.stop()
            }
        } );
        e.on( "gutterclick", function ( t ) {
            ...
            if ( n == "foldWidgets" ) {
                ...
                var i = e.session;
                if ( i.foldWidgets && i.foldWidgets[ r ] ) e.session.onFoldWidgetClick( r, t );
        ...
        e.on( "gutterdblclick", function ( t ) {
            ...
            if ( n == "foldWidgets" ) {
                var r = t.getDocumentPosition().row;
                var i = e.session;
                var s = i.getParentFoldRangeData( r, true );
...
define( "ace/keyboard/keybinding", [ "require", "exports", "module", "ace/lib/keys", "ace/lib/event" ], function ( e, t, n ) {
    ...
    ( function () {
        ...
        this.addKeyboardHandler = function ( e, t ) {
            ...
            if ( n != -1 ) this.$handlers.splice( n, 1 );
            if ( t == undefined ) this.$handlers.push( e );
            else this.$handlers.splice( t, 0, e ); if ( n == -1 && e.attach ) e.attach( this.$editor )
        };
        ...
        this.$callKeyboardHandlers = function ( e, t, n, r ) {
            ...
            for ( var a = this.$handlers.length; a--; ) {
                ...
                } if ( o && r && e != -1 && s.passEvent != true && s.command.passEvent != true ) {
                    i.stopEvent( r )
                }
                if ( o ) break
            }
        ...
        this.onTextInput = function ( e ) {
            ...
            if ( !t ) this.$editor.commands.exec( "insertstring", this.$editor, e )
        }
    } ).call( s.prototype );
    t.KeyBinding = s
} );
define( "ace/edit_session", [ "require", "exports", "module", "ace/lib/oop", "ace/lib/lang", "ace/config", "ace/lib/event_emitter", "ace/selection", "ace/mode/text", "ace/range", "ace/document", "ace/background_tokenizer", "ace/search_highlight", "ace/edit_session/folding", "ace/edit_session/bracket_match" ], function ( e, t, n ) {
    ...
    ( function () {
        ...
        this.highlightLines = function ( e, t, n, r ) {
            ...
            i.id = this.addMarker( i, n, "fullLine", r );
            return i
        };
        ...
        this.getWordRange = function ( e, t ) {
            ...
            if ( !r ) r = !!n.charAt( t ).match( this.tokenRe );
        ...
        this.setMode = function ( e, t ) {
            if ( e && typeof e === "object" ) {
                ...
                r = e || "ace/mode/text"
            } if ( !this.$modes[ "ace/mode/text" ] ) this.$modes[ "ace/mode/text" ] = new a;
            if ( this.$modes[ r ] && !n ) {
        ...
        this.$computeWidth = function ( e ) {
            if ( this.$modified || e ) {
                ...
                for ( var a = 0; a < u; a++ ) {
                    ...
                    if ( n[ a ] == null ) n[ a ] = this.$getStringScreenWidth( t[ a ] )[ 0 ];
                    if ( n[ a ] > r ) r = n[ a ]
                }
                this.screenWidth = r
            }
        ...
        this.undoChanges = function ( e, t ) {
            ...
            for ( var r = e.length - 1; r != -1; r-- ) {
                ...
                if ( i.group == "doc" ) {
                    ...
                    n = this.$getUndoSelection( i.deltas, true, n )
                } else {
        ...
        this.redoChanges = function ( e, t ) {
            ...
            for ( var r = 0; r < e.length; r++ ) {
                ...
                if ( i.group == "doc" ) {
                    ...
                    n = this.$getUndoSelection( i.deltas, false, n )
                }
            }
            this.$fromUndo = false;
            n && this.$undoSelect && !t && this.selection.setSelectionRange( n );
        ...
        this.$getUndoSelection = function ( e, t, n ) {
            ...
            var u = false;
            if ( r( i ) ) {
                s = f.fromPoints( i.range.start, i.range.end );
                u = true
            } else {
            ...
            if ( n != null ) {
                if ( f.comparePoints( n.start, s.start ) == 0 ) {
        ...
        this.moveText = function ( e, t, n ) {
            ...
            if ( !n ) {
                ...
                if ( u ) {
                    if ( s.start.row == e.end.row && s.start.column > e.end.column ) s.start.column += u;
                    if ( s.end.row == e.end.row && s.end.column > e.end.column ) s.end.column += u
                }
            ...
            if ( i.length ) {
                ...
                this.addFolds( i.map( function ( e ) {
                    e = e.clone();
                    if ( e.start.row == a.row ) e.start.column += u;
                    if ( e.end.row == a.row ) e.end.column += u;
                    e.start.row += o;
                    e.end.row += o;
                    return e
                } ) )
        ...
        this.$moveLines = function ( e, t, n ) {
            ...
            var u = n == 0 ? this.doc.getLines( e, t ) : this.doc.removeLines( e, t );
        ...
        this.$updateInternalDataOnChange = function ( e ) {
            ...
            this.$updating = false;
            if ( t ) this.$updateWrapData( i, s );
            else this.$updateRowLengthCache( i, s );
            return a
        };
        ...
        this.$updateWrapData = function ( e, t ) {
            ...
            while ( f <= t ) {
                ...
                if ( !a ) {
                    o = this.$getDisplayTokens( n[ f ] );
                    i[ f ] = this.$computeWrapSplits( o, s, r );
                    f++
                } else {
                    o = [];
                    a.walk( function ( e, t, r, i ) {
                        var s;
                        if ( e != null ) {
                    ...
                    i[ a.start.row ] = this.$computeWrapSplits( o, s, r );
                    f = a.end.row + 1
                }
            }
        };
        ...
        this.screenToDocumentPosition = function ( e, t ) {
            ...
            if ( p && p.start.row <= r ) {
                ...
                if ( v ) {
                    s = v[ e - o ];
                    if ( e > o && v.length ) {
                        i = v[ e - o - 1 ] || v[ v.length - 1 ];
                        n = n.substring( i )
                    }
                }
            }
            i += this.$getStringScreenWidth( n, t )[ 1 ];
            if ( this.$useWrapMode && i >= s ) i = s - 1;
            if ( p ) return p.idxToPosition( i );
            return {
                row: r,
                column: i
            }
    ...
    s.defineOptions( p.prototype, "session", {
        ...
        wrapMethod: {
            set: function ( e ) {
                if ( e == "auto" ) this.$wrapAsCode = this.$mode.type != "text";
                else this.$wrapAsCode = e != "text"
            },
            initialValue: "auto"
        },
        firstLineNumber: {
...
define( "ace/selection", [ "require", "exports", "module", "ace/lib/oop", "ace/lib/lang", "ace/lib/event_emitter", "ace/range" ], function ( e, t, n ) {
    ...
    ( function () {
        ...
        this.shiftSelection = function ( e ) {
            ...
            if ( !r || t.column !== 0 ) this.setSelectionAnchor( t.row, t.column + e );
            if ( r || n.column !== 0 ) {
        ...
        this.getLineRange = function ( e, t ) {
            ...
            if ( i ) {
                ...
                r = n
            } if ( t === true ) return new o( n, 0, r, this.session.getLine( r ).length );
            else return new o( n, 0, r + 1, 0 )
        };
        ...
        this.moveCursorLeft = function () {
            ...
            if ( t = this.session.getFoldAt( e.row, e.column, -1 ) ) {
                ...
                if ( this.session.isTabStop( e ) && this.doc.getLine( e.row ).slice( e.column - n, e.column ).split( " " ).length - 1 == n ) this.moveCursorBy( 0, -n );
        ...
        this.moveCursorRight = function () {
            ...
            if ( t = this.session.getFoldAt( e.row, e.column, 1 ) ) {
                ...
                var n = this.session.getTabSize();
                var e = this.lead;
                if ( this.session.isTabStop( e ) && this.doc.getLine( e.row ).slice( e.column, e.column + n ).split( " " ).length - 1 == n ) this.moveCursorBy( 0, n );
                else this.moveCursorBy( 0, 1 )
            }
        };
        this.moveCursorLineStart = function () {
            ...
            var s = i.match( /^\s*/ );
            if ( s[ 0 ].length != t && !this.session.$useEmacsStyleLineStart ) r.column += s[ 0 ].length;
        ...
        this.moveCursorBy = function ( e, t ) {
            ...
            if ( t === 0 ) {
                if ( this.$desiredColumn ) n.column = this.$desiredColumn;
                else this.$desiredColumn = n.column
            }
            ...
            if ( e.start == undefined ) {
                if ( this.rangeList ) {
                    ...
                    for ( var t = e.length; t--; ) {
                        ...
                        if ( e.isBackwards ) n.cursor = n.start;
                        this.addRange( n, true )
                    }
                    return
                } else e = e[ 0 ]
            }
...
define( "ace/range", [ "require", "exports", "module" ], function ( e, t, n ) {
    ...
    ( function () {
        ...
        this.collapseRows = function () {
            if ( this.end.column == 0 ) return new i( this.start.row, 0, Math.max( this.start.row, this.end.row - 1 ), 0 );
            else return new i( this.start.row, 0, this.end.row, 0 )
        };
    ...
    ( function () {
        ...
        this.toggleCommentLines = function ( e, t, n, r ) {
            ...
            if ( !this.lineCommentStart ) {
                ...
                var m = function ( e, t ) {
                    var n;
                    if ( n = e.match( d ) ) i.removeInLine( t, e.length - n[ 0 ].length, e.length );
                    if ( n = e.match( p ) ) i.removeInLine( t, n[ 1 ].length, n[ 0 ].length )
                };
                var g = function ( e, n ) {
                    if ( p.test( e ) ) return true;
                    var r = t.getTokens( n );
                    for ( var i = 0; i < r.length; i++ ) {
                        if ( r[ i ].type === "comment" ) return true
                    }
                }
            } else {
                ...
                var m = function ( e, t ) {
                    ...
                    var r = n[ 1 ].length,
                        s = n[ 0 ].length;
                    if ( !b( e, r, s ) && n[ 0 ][ s - 1 ] == " " ) s--;
                    i.removeInLine( t, r, s )
                };
                var y = c + " ";
                var v = function ( e, t ) {
                    if ( !s || /\S/.test( e ) ) {
                        if ( b( e, a, a ) ) i.insertInLine( {
                            row: t,
                            column: a
                        }, y );
                        else i.insertInLine( {
        ...
        this.toggleBlockComment = function ( e, t, n, r ) {
            ...
            } if ( l.start.row == c ) l.start.column += h;
            if ( l.end.row == c ) l.end.column += h;
                ...
                for ( var r in t ) {
                    ...
                    for ( var s = 0, o = i.length; s < o; s++ ) {
                        if ( typeof i[ s ].token === "string" ) {
                            if ( /keyword|support|storage/.test( i[ s ].token ) ) n.push( i[ s ].regex )
    ...
    var i = function ( e ) {
        ...
        for ( var t in this.states ) {
            ...
            for ( var a = 0; a < n.length; a++ ) {
                var f = n[ a ];
                if ( f.defaultToken ) s.defaultToken = f.defaultToken;
                if ( f.caseInsensitive ) o = "gi";
                if ( f.regex == null ) continue;
                if ( f.regex instanceof RegExp ) f.regex = f.regex.toString().slice( 1, -1 );
                var l = f.regex;
                var c = ( new RegExp( "(?:(" + l + ")|(.))" ) ).exec( "a" ).length - 2;
                if ( Array.isArray( f.token ) ) {
                    if ( f.token.length == 1 || c == 1 ) {
                        f.token = f.token[ 0 ]
                    } else if ( c - 1 != f.token.length ) {
                ...
                } else if ( typeof f.token == "function" && !f.onMatch ) {
                    if ( c > 1 ) f.onMatch = this.$applyToken;
                    else f.onMatch = f.token
                }
                if ( c > 1 ) {
                    if ( /\\\d/.test( f.regex ) ) {
                    ...
                    } if ( !f.splitRegex && typeof f.token != "string" ) u.push( f )
                }
                s[ i ] = a;
                i += c;
                r.push( l );
                if ( !f.onMatch ) f.onMatch = null;
                f.__proto__ = null
            }
    ...
    ( function () {
        ...
        this.createSplitterRegexp = function ( e, t ) {
            if ( e.indexOf( "(?=" ) != -1 ) {
                ...
                if ( i.end != null && /^\)*$/.test( e.substr( i.end ) ) ) e = e.substring( 0, i.start ) + e.substr( i.end )
            }
        ...
        this.getLineTokens = function ( e, t ) {
            ...
            while ( a = u.exec( e ) ) {
                ...
                for ( var g = 0; g < a.length - 2; g++ ) {
                    ...
                    p = s[ o[ g ] ];
                    if ( p.onMatch ) h = p.onMatch( d, i, n );
                    else h = p.token; if ( p.next ) {
                        if ( typeof p.next == "string" ) i = p.next;
                        else i = p.next( i, n );
                        s = this.states[ i ];
                        if ( !s ) {
                            window.console && console.error && console.error( i, "doesn't exist" );
                            i = "start";
                            s = this.states[ i ]
                        }
...
define( "ace/mode/text_highlight_rules", [ "require", "exports", "module", "ace/lib/lang" ], function ( e, t, n ) {
    ...
    ( function () {
        ...
        var e = function ( e, t ) {
            if ( e != "start" ) t.unshift( this.nextState, e );
            return this.nextState
        };
        var t = function ( e, t ) {
            if ( t[ 0 ] !== e ) return "start";
            t.shift();
            return t.shift()
        };
                ...
                for ( var u = 0; u < o.length; u++ ) {
                    ...
                    if ( a.rules ) {
                        for ( var c in a.rules ) {
                            if ( r[ c ] ) {
                                if ( r[ c ].push ) r[ c ].push.apply( r[ c ], a.rules[ c ] )
                            } else {
                                r[ c ] = a.rules[ c ]
                            }
                        }
                    ...
                    if ( p ) {
                        var d = [ u, 1 ].concat( p );
                        if ( a.noEscape ) d = d.filter( function ( e ) {
                            return !e.next
                        } );
                        o.splice.apply( o, d );
                        u--;
...
define( "ace/document", [ "require", "exports", "module", "ace/lib/oop", "ace/lib/event_emitter", "ace/range", "ace/anchor" ], function ( e, t, n ) {
    ...
    ( function () {
        ...
        if ( "aaa".split( /a/ ).length == 0 ) this.$split = function ( e ) {
            return e.replace( /\r\n|\r/g, "\n" ).split( "\n" )
        };
        else this.$split = function ( e ) {
            return e.split( /\r\n|\r|\n/ )
        };
        this.$detectNewLine = function ( e ) {
            var t = e.match( /^.*?(\r\n|\r|\n)/m );
        ...
        this.getTextRange = function ( e ) {
            ...
            var n = t.length - 1;
            if ( e.end.row - e.start.row == n ) t[ n ] = t[ n ].substring( 0, e.end.column );
        ...
        this.insert = function ( e, t ) {
            ...
            var i = n.length == 0 ? null : n.splice( n.length - 1, 1 )[ 0 ];
        ...
        this.insertLines = function ( e, t ) {
            if ( e >= this.getLength() ) return this.insert( {
                row: e,
                column: 0
            }, "\n" + t.join( "\n" ) );
        ...
        this.remove = function ( e ) {
            ...
            if ( e.isMultiLine() ) {
                ...
                var i = n - 1;
                if ( e.end.column > 0 ) this.removeInLine( n, 0, e.end.column );
                if ( i >= r ) this._removeLines( r, i );
                if ( r != t ) {
        ...
        this.removeLines = function ( e, t ) {
            if ( e < 0 || t >= this.getLength() ) return this.remove( new s( e, 0, t + 1, 0 ) );
        ...
        this.applyDeltas = function ( e ) {
            for ( var t = 0; t < e.length; t++ ) {
                ...
                if ( n.action == "insertLines" ) this.insertLines( r.start.row, n.lines );
                else if ( n.action == "insertText" ) this.insert( r.start, n.text );
                else if ( n.action == "removeLines" ) this._removeLines( r.start.row, r.end.row - 1 );
                else if ( n.action == "removeText" ) this.remove( r )
            }
        };
        this.revertDeltas = function ( e ) {
            for ( var t = e.length - 1; t >= 0; t-- ) {
                var n = e[ t ];
                var r = s.fromPoints( n.range.start, n.range.end );
                if ( n.action == "insertLines" ) this._removeLines( r.start.row, r.end.row - 1 );
                else if ( n.action == "insertText" ) this.remove( r );
                else if ( n.action == "removeLines" ) this._insertLines( r.start.row, n.lines );
                else if ( n.action == "removeText" ) this.insert( r.start, n.text )
            }
        };
...
define( "ace/anchor", [ "require", "exports", "module", "ace/lib/oop", "ace/lib/event_emitter" ], function ( e, t, n ) {
    ...
    var s = t.Anchor = function ( e, t, n ) {
        this.$onChange = this.onChange.bind( this );
        this.attach( e );
        if ( typeof n == "undefined" ) this.setPosition( t.row, t.column );
        else this.setPosition( t, n )
    };
    ( function () {
        r.implement( this, i );
        ...
        this.onChange = function ( e ) {
            ...
            if ( t.action === "insertText" ) {
                if ( s.row === r && s.column <= i ) {
                    if ( s.column === i && this.$insertRight ) {} else if ( s.row === o.row ) {
                        i += o.column - s.column
                    } else {
                        i -= s.column;
                        r += o.row - s.row
                    }
                } else if ( s.row !== o.row && s.row < r ) {
                    r += o.row - s.row
                }
            } else if ( t.action === "insertLines" ) {
                if ( s.row <= r ) {
                    r += o.row - s.row
                }
            } else if ( t.action === "removeText" ) {
                if ( s.row === r && s.column < i ) {
                    if ( o.column >= i ) i = s.column;
                    else i = Math.max( 0, i - ( o.column - s.column ) )
                } else if ( s.row !== o.row && s.row < r ) {
                    if ( o.row === r ) i = Math.max( 0, i - o.column ) + s.column;
                    r -= o.row - s.row
                } else if ( o.row === r ) {
                    r -= o.row - s.row;
                    i = Math.max( 0, i - o.column ) + s.column
                }
            } else if ( t.action == "removeLines" ) {
                if ( s.row <= r ) {
                    if ( o.row <= r ) r -= o.row - s.row;
                    else {
                        r = s.row;
                        i = 0
                    }
        ...
        this.update = function ( e, t, n, i ) {
            ...
            for ( var a = o; a <= u; a++ ) {
                ...
                if ( f == null ) {
                    ...
                    if ( f.length > this.MAX_RANGES ) f = f.slice( 0, this.MAX_RANGES );
                    f = f.map( function ( e ) {
...
define( "ace/edit_session/folding", [ "require", "exports", "module", "ace/range", "ace/edit_session/fold_line", "ace/edit_session/fold", "ace/token_iterator" ], function ( e, t, n ) {
    function u() {
            ...
            for ( var s = 0; s < i.length; s++ ) {
                ...
                if ( o.range.contains( e, t ) ) {
                    if ( n == 1 && o.range.isEnd( e, t ) ) {
                        continue
                    } else if ( n == -1 && o.range.isStart( e, t ) ) {
                        continue
                    }
                    return o
                }
        ...
        this.getFoldStringAt = function ( e, t, n, r ) {
            ...
            if ( !s ) s = this.getLine( o.start.row ).substring( i.end.column );
            if ( n == -1 ) return s.substring( 0, t - i.end.column );
            else if ( n == 1 ) return s.substring( t - i.end.column );
            else return s
        };
        ...
        this.addFold = function ( e, t ) {
            ...
            var f = o.end.row;
            var l = o.end.column;
            if ( !( u < f || u == f && a <= l - 2 ) ) throw new Error( "The range has to be at least 2 characters width" );
            ...
            for ( var d = 0; d < n.length; d++ ) {
                ...
                if ( f == v.start.row ) {
                    ...
                    break
                } else if ( f <= v.start.row ) {
                    break
                }
            }
            if ( !r ) v = this.$addFoldLine( new i( this.$foldData, o ) );
        ...
        this.removeFold = function ( e ) {
            ...
            if ( s.length == 1 ) {
                ...
                if ( this.$useWrapMode ) this.$updateWrapData( n, r );
        ...
        this.getDisplayLine = function ( e, t, n, r ) {
            ...
            if ( !i ) {
                ...
                return s.substring( r || 0, t || s.length )
            } else {
        ...
        this.toggleFold = function ( e ) {
            ...
            if ( n.isEmpty() ) {
                ...
                if ( r ) {
                    this.expandFold( r );
                    return
                } else if ( i = this.findMatchingBracket( s ) ) {
                    if ( n.comparePoint( i ) == 1 ) {
                        n.end = i
                    } else {
                        n.start = i;
                        n.start.column++;
                ...
                } else if ( i = this.findMatchingBracket( {
                    row: s.row,
                    column: s.column + 1
                } ) ) {
                    if ( n.comparePoint( i ) == 1 ) n.end = i;
                    else n.start = i;
                    n.start.column++
                } else {
            ...
            } if ( !r ) r = this.getFoldAt( n.start.row, n.start.column );
        ...
        this.foldAll = function ( e, t, n ) {
            ...
            e = e || 0;
            for ( var i = e; i < t; i++ ) {
                if ( r[ i ] == null ) r[ i ] = this.getFoldWidget( i );
        ...
        this.getParentFoldRangeData = function ( e, t ) {
            ...
            while ( r >= 0 ) {
                var s = n[ r ];
                if ( s == null ) s = n[ r ] = this.getFoldWidget( r );
                if ( s == "start" ) {
        ...
        this.onFoldWidgetClick = function ( e, t ) {
            ...
            var o = t.altKey;
            var u = n === "end" ? -1 : 1;
            var a = this.getFoldAt( e, u === -1 ? 0 : r.length, u );
            if ( a ) {
                if ( i || s ) this.removeFold( a );
                else this.expandFold( a );
                return
            }
            ...
            if ( o ) {
                ...
                if ( s ) f.collapseChildren = 1e4;
                this.addFold( "...", f )
            }
            if ( !f )( t.target || t.srcElement ).className += " ace_invalid"
        };
    ...
    ( function () {
        ...
        this.pointIndex = function ( e, t, n ) {
            ...
            for ( var s = n || 0; s < r.length; s++ ) {
                ...
                if ( u > 0 ) continue;
                var a = i( e, o.start );
                if ( u === 0 ) return t && a !== 0 ? -s - 2 : s;
                if ( a > 0 || a === 0 && !t ) return s;
                return -s - 1
            }
            return -s - 1
        };
        ...
        this.$onChange = function ( e ) {
            ...
            for ( var f = 0, l = a.length; f < l; f++ ) {
                ...
                if ( c.start.row == i && c.start.column >= n.column ) {
                    if ( c.start.column == n.column && this.$insertRight ) {} else {
                        c.start.column += u;
                        c.start.row += o
                    }
                }
                if ( c.end.row == i && c.end.column >= n.column ) {
                    ...
                    if ( c.end.column == n.column && u > 0 && f < l - 1 ) {
                        if ( c.end.column > c.start.column && c.end.column == a[ f + 1 ].start.column ) c.end.column -= u
                    }
                    c.end.column += u;
                    c.end.row += o
                }
...
define( "ace/edit_session/bracket_match", [ "require", "exports", "module", "ace/token_iterator", "ace/range" ], function ( e, t, n ) {
    function s() {
        this.findMatchingBracket = function ( e, t ) {
            ...
            var r = n.match( /([\(\[\{])|([\)\]\}])/ );
            if ( !r ) return null;
            if ( r[ 1 ] ) return this.$findClosingBracket( r[ 1 ], e );
            else return this.$findOpeningBracket( r[ 2 ], e )
        };
...
define( "ace/search", [ "require", "exports", "module", "ace/lib/lang", "ace/lib/oop", "ace/range" ], function ( e, t, n ) {
    ...
    ( function () {
        ...
        this.$matchIterator = function ( e, t ) {
            ...
            if ( t.$isMultiLine ) {
                ...
                var f = function ( t, r, i ) {
                    ...
                    if ( n.offset == 1 ) {
                        c.start.row--;
                        c.start.column = Number.MAX_VALUE
                    } else if ( i ) c.start.column += i;
                    if ( o( c ) ) return true
                }
            } else if ( u ) {
        ...
        this.$assembleRegExp = function ( e, t ) {
            ...
            if ( !e.regExp ) n = r.escapeRegExp( n );
            if ( e.wholeWord ) n = "\\b" + n + "\\b";
        ...
        this.$lineIterator = function ( e, t ) {
            ...
            var i = t.range;
            var s = t.start;
            if ( !s ) s = i ? i[ n ? "end" : "start" ] : e.selection.getRange();
            if ( s.start ) s = s[ r != n ? "end" : "start" ];
...
define( "ace/keyboard/hash_handler", [ "require", "exports", "module", "ace/lib/keys", "ace/lib/useragent" ], function ( e, t, n ) {
    ...
    ( function () {
        ...
        this.parseKeys = function ( e ) {
            if ( e.indexOf( " " ) != -1 ) e = e.split( /\s+/ ).pop();
...
define( "ace/virtual_renderer", [ "require", "exports", "module", "ace/lib/oop", "ace/lib/dom", "ace/lib/useragent", "ace/config", "ace/layer/gutter", "ace/layer/marker", "ace/layer/text", "ace/layer/cursor", "ace/scrollbar", "ace/renderloop", "ace/lib/event_emitter" ], function ( e, t, n ) {
    ...
    var m = function ( e, t ) {
        ...
        this.scrollBarV.addEventListener( "scroll", function ( e ) {
            if ( !n.$scrollAnimation ) n.session.setScrollTop( e.data - n.scrollMargin.top )
        } );
        this.scrollBarH.addEventListener( "scroll", function ( e ) {
            if ( !n.$scrollAnimation ) n.session.setScrollLeft( e.data - n.scrollMargin.left )
        } );
        this.scrollTop = 0;
        this.scrollLeft = 0;
        this.cursorPos = {
    ...
    ( function () {
        ...
        this.onResize = function ( e, t, n, r ) {
            ...
            if ( !r ) r = i.clientHeight || i.scrollHeight;
            if ( !n ) n = i.clientWidth || i.scrollWidth;
            ...
            else this.$loop.schedule( s | this.$changes ); if ( this.resizing ) this.resizing = 0
        };
        this.$updateCachedSize = function ( e, t, n, r ) {
            ...
            if ( n && ( e || s.width != n ) ) {
                ...
                if ( this.session && this.session.getUseWrapMode() && this.adjustWrapLimit() || e ) i = i | this.CHANGE_FULL
            }
            if ( i ) this._signal( "resize", o );
            return i
        };
        ...
        this.$updateGutterLineHighlight = function () {
            ...
            if ( this.session.getUseWrapMode() ) {
                ...
                n.column = 0;
                e = this.$cursorLayer.getPixelPosition( n, true );
        ...
        this.$moveTextAreaToCursor = function () {
            ...
            n -= this.scrollLeft;
            if ( n > this.$size.scrollerWidth - i ) n = this.$size.scrollerWidth - i;
        ...
        this.$renderChanges = function ( e, t ) {
            ...
            if ( e & this.CHANGE_SCROLL ) {
                ...
                else this.$textLayer.scrollLines( this.layerConfig ); if ( this.$showGutter ) this.$gutterLayer.update( this.layerConfig );
                this.$markerBack.update( this.layerConfig );
                this.$markerFront.update( this.layerConfig );
                this.$cursorLayer.update( this.layerConfig );
                this.$highlightGutterLine && this.$updateGutterLineHighlight();
            ...
            if ( e & this.CHANGE_TEXT ) {
                ...
                if ( this.$updateLines() || e & this.CHANGE_GUTTER && this.$showGutter ) this.$gutterLayer.update( this.layerConfig )
        ...
        this.$autosize = function ( e, t ) {
            ...
            if ( r != this.desiredHeight || this.$size.height != this.desiredHeight || i != this.$vScroll ) {
                ...
                this.$updateCachedSize( true, this.$gutterWidth, s, r );
        ...
        this.$computeLayerConfig = function () {
            ...
            if ( !this.$maxLines && this.$scrollPastEnd ) {
                if ( this.scrollTop > r - this.$size.scrollerHeight ) r += Math.min( ( this.$size.scrollerHeight - this.lineHeight ) * this.$scrollPastEnd, this.scrollTop - r + this.$size.scrollerHeight )
            }
            ...
            var y = 0;
            if ( a || l ) {
                y = this.$updateCachedSize( true, this.gutterWidth, this.$size.width, this.$size.height );
                this._signal( "scrollbarVisibilityChanged" );
                if ( l ) o = this.$getLongestLine()
            }
            this.layerConfig = {
                width: o,
        ...
        this.$updateLines = function () {
            ...
            if ( t === Infinity ) {
                if ( this.$showGutter ) this.$gutterLayer.update( n );
                this.$textLayer.update( n );
                return
            }
            this.$textLayer.updateLines( n, e, t );
            return true
        };
        ...
        this.scrollCursorIntoView = function ( e, t ) {
            ...
            if ( s > i ) {
                if ( t ) i -= t * this.$size.scrollerHeight;
                if ( i == 0 ) i = -this.scrollMargin.top;
                else if ( i == 0 ) i = +this.scrollMargin.bottom;
                this.session.setScrollTop( i )
            } else if ( s + this.$size.scrollerHeight < i + this.lineHeight ) {
                if ( t ) i += t * this.$size.scrollerHeight;
            ...
            } else if ( o + this.$size.scrollerWidth < r + this.characterWidth ) {
                this.session.setScrollLeft( Math.round( r + this.characterWidth - this.$size.scrollerWidth ) )
            } else if ( o <= this.$padding && r - o < this.characterWidth ) {
        ...
        this.scrollToLine = function ( e, t, n, r ) {
            ...
            if ( n !== false ) this.animateScrolling( o, r )
        };
        ...
        this.setStyle = function ( e, t ) {
            i.setCssClass( this.container, e, t != false )
        };
        this.unsetStyle = function ( e ) {
    ...
    ( function () {
        ...
        this.setAnnotations = function ( e ) {
            ...
            for ( var r = 0; r < e.length; r++ ) {
                ...
                var u = i.type;
                if ( u == "error" ) t.className = " ace_error";
                else if ( u == "warning" && t.className != " ace_error" ) t.className = " ace_warning";
                else if ( u == "info" && !t.className ) t.className = " ace_info"
            }
        };
        this.$updateAnnotations = function ( e ) {
            ...
            var r = n.start.row;
            var i = n.end.row - r;
            if ( i === 0 ) {} else if ( t.action == "removeText" || t.action == "removeLines" ) {
        ...
        this.update = function ( e ) {
            ...
            while ( true ) {
                if ( p > s ) {
                    p = i.end.row + 1;
                    i = this.session.getNextFoldLine( p, i );
                ...
                if ( u[ p ] ) d += u[ p ];
                if ( a[ p ] ) d += a[ p ];
                if ( this.$annotations[ p ] ) d += this.$annotations[ p ].className;
                if ( c.element.className != d ) c.element.className = d;
                var v = this.session.getRowLength( p ) * e.lineHeight + "px";
                if ( v != c.element.style.height ) c.element.style.height = v;
                var m = l = p + f;
                if ( m != c.textNode.data ) c.textNode.data = m;
                if ( o ) {
                    var g = o[ p ];
                    if ( g == null ) g = o[ p ] = this.session.getFoldWidget( p )
                }
                if ( g ) {
                    if ( !c.foldWidget ) {
                        c.foldWidget = r.createElement( "span" );
                        c.element.appendChild( c.foldWidget )
                    }
                    var d = "ace_fold-widget ace_" + g;
                    if ( g == "start" && p == s && p < i.end.row ) d += " ace_closed";
                    else d += " ace_open"; if ( c.foldWidget.className != d ) c.foldWidget.className = d;
                    var v = e.lineHeight + "px";
                    if ( c.foldWidget.style.height != v ) c.foldWidget.style.height = v
                } else {
                    if ( c.foldWidget != null ) {
        ...
        this.setShowFoldWidgets = function ( e ) {
            if ( e ) r.addCssClass( this.element, "ace_folding-enabled" );
            else r.removeCssClass( this.element, "ace_folding-enabled" );
    ...
    ( function () {
        ...
        this.update = function ( e ) {
            ...
            for ( var n in this.markers ) {
                ...
                } else if ( r.type == "fullLine" ) {
                    this.drawFullLineMarker( t, s, r.clazz, e )
                } else if ( r.type == "screenLine" ) {
                    this.drawScreenLineMarker( t, s, r.clazz, e )
                } else if ( s.isMultiLine() ) {
                    if ( r.type == "text" ) this.drawTextMarker( t, s, r.clazz, e );
                    else this.drawMultiLineMarker( t, s, r.clazz, e )
                } else {
        ...
        this.drawFullLineMarker = function ( e, t, n, r, i ) {
            ...
            var o = r.lineHeight;
            if ( t.start.row != t.end.row ) o += this.$getTop( t.end.row, r ) - s;
    ...
    ( function () {
        ...
        this.updateLines = function ( e, t, n ) {
            ...
            while ( true ) {
                ...
                if ( c ) {
                    var h = [];
                    this.$renderLine( h, a, !this.$useLineGroups(), a == l ? f : false );
        ...
        this.scrollLines = function ( e ) {
            ...
            if ( e.firstRow < t.firstRow ) {
                ...
                if ( n.firstChild ) n.insertBefore( i, n.firstChild );
        ...
        this.$renderLinesFragment = function ( e, t, n ) {
            ...
            while ( true ) {
                ...
                var f = [];
                this.$renderLine( f, s, false, s == u ? o : false );
                a.innerHTML = f.join( "" );
        ...
        this.update = function ( e ) {
            ...
            while ( true ) {
                ...
                this.$renderLine( t, s, false, s == u ? o : false );
        ...
        this.$renderToken = function ( e, t, n, r ) {
            ...
            var u = function ( e, n, r, o, u ) {
                if ( n ) {
                    ...
                    t += a - 1;
                    return i.$tabStrings[ a ]
                } else if ( e == "　" ) {
                    var f = i.showInvisibles ? "ace_cjk ace_invisible" : "ace_cjk";
                    var l = i.showInvisibles ? i.SPACE_CHAR : "";
                    t += 1;
                    return "<span class='" + f + "' style='width:" + i.config.characterWidth * 2 + "px'>" + l + "</span>"
                } else if ( r ) {
                    return "<span class='ace_invisible ace_invalid'>" + i.SPACE_CHAR + "</span>"
                } else {
                    t += 1;
                    return "<span class='ace_cjk' style='width:" + i.config.characterWidth * 2 + "px'>" + e + "</span>"
                }
            };
            var a = r.replace( o, u );
            if ( !this.$textToken[ n.type ] ) {
                ...
                var l = "";
                if ( n.type == "fold" ) l = " style='width:" + n.value.length * this.config.characterWidth + "px;' ";
        ...
        this.$renderSimpleLine = function ( e, t ) {
            ...
            var r = t[ 0 ];
            var i = r.value;
            if ( this.displayIndentGuides ) i = this.renderIndentGuide( e, i );
            if ( i ) n = this.$renderToken( e, n, r, i );
            for ( var s = 1; s < t.length; s++ ) {
                r = t[ s ];
                i = r.value;
        ...
        this.$renderLine = function ( e, t, n, r ) {
            if ( !r && r != false ) r = this.session.getFoldLine( t );
            if ( r ) var i = this.$getFoldLineTokens( t, r );
            else var i = this.session.getTokens( t ); if ( !n ) {
                e.push( "<div class='ace_line' style='height:", this.config.lineHeight, "px'>" )
            }
            if ( i.length ) {
                var s = this.session.getRowSplitData( t );
                if ( s && s.length ) this.$renderWrappedLine( e, i, s, n );
                else this.$renderSimpleLine( e, i )
            }
            if ( this.showInvisibles ) {
                if ( r ) t = r.end.row;
        ...
        this.$getFoldLineTokens = function ( e, t ) {
            function i( e, t, n ) {
                ...
                if ( s != t ) {
                    ...
                    if ( o.length > n - t ) o = o.substring( 0, n - t );
                    r.push( {
                        type: e[ i ].type,
                        value: o
                    } );
    ...
    ( function () {
        ...
        this.setSmoothBlinking = function ( e ) {
            if ( e != this.smoothBlinking ) {
                ...
                if ( e ) r.addCssClass( this.element, "ace_smooth-blinking" );
                else r.removeCssClass( this.element, "ace_smooth-blinking" );
                this.restartTimer()
            }
        };
        ...
        this.restartTimer = function () {
            ...
            if ( this.smoothBlinking ) r.removeCssClass( this.element, "ace_smooth-blinking" );
        ...
        this.update = function ( e ) {
            ...
            for ( var n = 0, i = t.length; n < i; n++ ) {
                var s = this.getPixelPosition( t[ n ].cursor, true );
        ...
        this.$setOverwrite = function ( e ) {
            if ( e != this.overwrite ) {
                this.overwrite = e;
                if ( e ) r.addCssClass( this.element, "ace_overwrite-cursors" );
                else r.removeCssClass( this.element, "ace_overwrite-cursors" )
            }
        };
        this.destroy = function () {
            clearInterval( this.intervalId );
...
define( "ace/multi_select", [ "require", "exports", "module", "ace/range_list", "ace/range", "ace/selection", "ace/mouse/multi_select_handler", "ace/lib/event", "ace/lib/lang", "ace/commands/multi_select_commands", "ace/search", "ace/edit_session", "ace/editor", "ace/config" ], function ( e, t, n ) {
    ...
    function g( e ) {
        ...
        u.addListener( t, "keydown", function ( t ) {
            if ( t.keyCode == 18 && !( t.ctrlKey || t.shiftKey || t.metaKey ) ) {
                if ( !n ) {
    ...
    ( function () {
        ...
        this.addRange = function ( e, t ) {
            ...
            this.$onAddRange( e );
            if ( r.length ) this.$onRemoveRange( r );
        ...
        this.splitIntoLines = function () {
            if ( this.rangeCount > 1 ) {
                ...
                var f = [];
                var l = this.getLineRange( s, true );
                l.start.column = n.start.column;
                f.push( l );
                for ( var c = s + 1; c < o; c++ ) f.push( this.getLineRange( c, true ) );
                l = this.getLineRange( o, true );
    ...
    ( function () {
        ...
        this.$onMultiSelectExec = function ( e ) {
            ...
            if ( !t.multiSelectAction ) {
                ...
                r = n.forEachSelection( t, e.args, true )
        ...
        this.forEachSelection = function ( e, t, n ) {
            ...
            this.onCursorChange();
            this.onSelectionChange();
            if ( h && h.from == h.to ) this.renderer.animateScrolling( h.from );
            return u
        };
        ...
        this.getSelectedText = function () {
            ...
            if ( this.inMultiSelectMode && !this.inVirtualSelectionMode ) {
                ...
                e = n.join( i );
                if ( e.length == ( n.length - 1 ) * i.length ) e = ""
        ...
        this.onPaste = function ( e ) {
            ...
            for ( var r = n.length; r--; ) {
                var i = n[ r ];
                if ( !i.isEmpty() ) this.session.remove( i );
        ...
        this.findAll = function ( e, t, n ) {
            ...
            if ( !n ) i.toSingleRange( r[ 0 ] );
            for ( var s = r.length; s--; ) i.addRange( r[ s ], true );
            this.$blockScrolling -= 1;
            return r.length
        };
        this.selectMoreLines = function ( e, t ) {
            ...
            if ( l ) this.selection.substractPoint( l )
        };
        ...
        this.selectMore = function ( e, t ) {
            ...
            if ( t ) this.multiSelect.substractPoint( i.cursor )
        };
        this.alignCursors = function () {
            ...
            if ( !n.length ) {
                ...
                n.forEach( function ( t, n ) {
                    ...
                    var s = c - r.column;
                    var o = p[ n ] - h;
                    if ( s > o ) e.insert( r, a.stringRepeat( " ", s - o ) );
                    else e.remove( new i( r.row, r.column, r.row, r.column - s + o ) );
        ...
        this.$reAlignText = function ( e ) {
            ...
            return e.map( function ( e ) {
                ...
                if ( r + i + s != o[ 1 ].length + o[ 2 ].length + o[ 3 ].length ) n = false;
                if ( r != o[ 1 ].length ) t = false;
                if ( r > o[ 1 ].length ) r = o[ 1 ].length;
                if ( i < o[ 2 ].length ) i = o[ 2 ].length;
    ...
    t.onSessionChange = function ( e ) {
        ...
        var n = e.oldSession;
        if ( n ) {
            n.multiSelect.removeEventListener( "addRange", this.$onAddRange );
        ...
        if ( this.inMultiSelectMode != t.selection.inMultiSelectMode ) {
...
define( "ace/mouse/multi_select_handler", [ "require", "exports", "module", "ace/lib/event" ], function ( e, t, n ) {
    ...
    function s( e ) {
        ...
        if ( !o && !n ) {
            if ( u == 0 && e.editor.inMultiSelectMode ) e.editor.exitMultiSelectMode();
            return
        }
        var a = e.editor;
        var f = a.selection;
        ...
        if ( o && !s && !n && u == 0 ) {
            ...
            a.once( "mouseup", function () {
                var e = f.toOrientedRange();
                if ( S && e.isEmpty() && i( S.cursor, e.cursor ) ) f.substractPoint( e.cursor );
                else {
                    if ( E ) {
                        a.removeSelectionMarker( E );
                        f.addRange( E )
                    }
                    f.addRange( e )
                }
            ...
            e.stop();
            if ( l && !o ) f.toSingleRange();
            else if ( !l && o ) f.addRange();
            var x = [];
            if ( s ) {
                b = y.documentToScreenPosition( f.lead );
                g()
            } else {
                f.moveCursorToPosition( c );
                f.clearSelection()
            }
            var T = function ( e ) {
                clearInterval( C );
...
define( "ace/worker/worker_client", [ "require", "exports", "module", "ace/lib/oop", "ace/lib/event_emitter", "ace/config" ], function ( e, t, n ) {
    ...
    var u = function ( e, t, n ) {
        ...
        var a = function () {
            ...
            if ( e.command ) r[ e.command ].apply( r, e.args );
...
define( "ace/placeholder", [ "require", "exports", "module", "ace/range", "ace/lib/event_emitter", "ace/lib/oop" ], function ( e, t, n ) {
    ...
    ( function () {
        ...
        this.setup = function () {
            ...
            this.markerId = n.addMarker( new r( i.row, i.column, i.row, i.column + this.length ), this.mainClass, null, false );
            this.pos.on( "change", function ( t ) {
                n.removeMarker( e.markerId );
                e.markerId = n.addMarker( new r( t.value.row, t.value.column, t.value.row, t.value.column + e.length ), e.mainClass, null, false )
            } );
            this.others = [];
        ...
        this.showOtherMarkers = function () {
            ...
            this.others.forEach( function ( n ) {
                n.markerId = e.addMarker( new r( n.row, n.column, n.row, n.column + t.length ), t.othersClass, null, false );
                n.on( "change", function ( i ) {
                    e.removeMarker( n.markerId );
                    n.markerId = e.addMarker( new r( i.value.row, i.value.column, i.value.row, i.value.column + t.length ), t.othersClass, null, false )
                } )
            } )
        };
                ...
                if ( !this.session.$fromUndo ) {
                    if ( t.action === "insertText" ) {
                        for ( var o = this.others.length - 1; o >= 0; o-- ) {
                            ...
                            if ( u.row === n.start.row && n.start.column < u.column ) a.column += i;
                    ...
                    if ( n.start.column === this.pos.column && t.action === "insertText" ) {
                        setTimeout( function () {
                            ...
                            for ( var e = 0; e < this.others.length; e++ ) {
                                ...
                                if ( t.row === n.start.row && n.start.column < t.column ) r.column += i;
                                t.setPosition( r.row, r.column )
                            }
                        }.bind( this ), 0 )
                    } else if ( n.start.column === this.pos.column && t.action === "removeText" ) {
                        setTimeout( function () {
                            for ( var e = 0; e < this.others.length; e++ ) {
                                var t = this.others[ e ];
...
define( "ace/mode/folding/fold_mode", [ "require", "exports", "module", "ace/range" ], function ( e, t, n ) {
    ...
    ( function () {
        ...
        this.getFoldWidget = function ( e, t, n ) {
            var r = e.getLine( n );
            if ( this.foldingStartMarker.test( r ) ) return "start";
            if ( t == "markbeginend" && this.foldingStopMarker && this.foldingStopMarker.test( r ) ) return "end";
            return ""
        };
        ...
        this.openingBracketBlock = function ( e, t, n, i, s ) {
            ...
            if ( a == null ) a = this.getFoldWidget( e, u.row );
            if ( a == "start" && u.row > o.row ) {
                u.row--;
...
( function () {
    window.require( [ "ace/ace" ], function ( e ) {
        ...
        for ( var t in e )
            if ( e.hasOwnProperty( t ) ) ace[ t ] = e[ t ]
    } )
} )();
if ( window.aceScriptLoaded ) {
